...
var y = getDefaultExportFromCjs(function() {
...
exports.code = code, exports.color = color, exports.css = css, exports.find = function(str) {
  ...
  pointer: "▸"
}, exports.regex = regex, exports.style = style;
